...
import ConversationInfoTab from "@src/components/modals/conversation-info-modal/conversation-info-tab/ConversationInfoTab.vue";
import EditGroupInfoTab from "@src/components/modals/conversation-info-modal/EditGroupInfoTab.vue";
import ConversationMembersTab from "@src/components/modals/conversation-info-modal/ConversationMembersTab.vue";
import SharedMediaTab from "@src/components/modals/conversation-info-modal/shared-media-tab/SharedMediaTab.vue";
