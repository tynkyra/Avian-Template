...
import CallInfoTab from "@src/components/modals/call-info-modal/CallInfoTab.vue";
import CallMembersTab from "@src/components/modals/call-info-modal/CallMembersTab.vue";
