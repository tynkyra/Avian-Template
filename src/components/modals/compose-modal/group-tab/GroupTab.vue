...
import GroupInfo from "@src/components/modals/compose-modal/group-tab/GroupInfo.vue";
import GroupMembers from "@src/components/modals/compose-modal/group-tab/GroupMembers.vue";
