...
import PasswordSection from "@src/components/forms/register-form/PasswordSection.vue";
import PersonalSection from "@src/components/forms/register-form/PersonalSection.vue";
